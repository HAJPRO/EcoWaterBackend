...
class SaleController {
    ...
    async AllOrderProccessById(req, res, next) {
        try {
            const proccess = await SaleService.AllOrderProccessById(
                req.params.id
            );
    ...
    async confirm(req, res, next) {
        try {
            const data = await SaleService.confirm(req.body.id);
    ...
    async getOne(req, res, next) {
        try {
            const data = await SaleService.getOne(req.params.id);
