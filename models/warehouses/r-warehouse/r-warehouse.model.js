...
const ReadyWarehouseSchema = new Schema({
  partyNumber: { type: String, required: true, unique: true },
  product: { type: String, required: true },        // Partiya raqami (masalan: PART-2025-0001)
  ...
  products: [                                                            // Partiyadagi mahsulotlar ro‘yxati
    {
      ...
      code: { type: String },                                     // Mahsulot kategoriyasi (masalan: ichimlik, un, kiyim)
