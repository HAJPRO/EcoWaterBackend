...
class AddressService {
  ...
  async Neighborhoods(data) {
    const neighborhoods = [
      ...
      { id: 15, districtId: 11, name: "Saidkent" },
      { id: 16, districtId: 11, name: "Mirakon" },
      { id: 17, districtId: 11, name: "Baqollar" },
      { id: 18, districtId: 11, name: "Gishti" },
      { id: 19, districtId: 11, name: "Sharq" },
      { id: 20, districtId: 11, name: "Dilkusho" },
      { id: 21, districtId: 11, name: "A.G‘ijduvoniy" },
      { id: 22, districtId: 11, name: "Nodirabegim" },
      { id: 23, districtId: 11, name: "Guliston" },
      { id: 24, districtId: 11, name: "Obod" },
      { id: 25, districtId: 11, name: "Jovgari" },
      { id: 26, districtId: 11, name: "Labirut" },
      { id: 27, districtId: 11, name: "Nodirabegim" },
      { id: 28, districtId: 11, name: "Gijduvon shahri" },

// Shofirkon 


  { id: 1, districtId: 19, name: "Shofirkon shahar" }, 
  { id: 2, districtId: 19, name: "Joʻyrabot" },
  { id: 3, districtId: 19, name: "Iskogare" },
  { id: 4, districtId: 19, name: "Quyi Chuqurak" },
  { id: 5, districtId: 19, name: "Mirzoqul" },
  { id: 6, districtId: 19, name: "Talisafed" },
  { id: 7, districtId: 19, name: "Undare" },
  { id: 8, districtId: 19, name: "Chandir" },
  { id: 9, districtId: 19, name: "Gʻulomte" },
  { id: 10, districtId: 19, name: "Vargonze" },
  { id: 11, districtId: 19, name: "Denov" },
  { id: 12, districtId: 19, name: "Joʻynav" },
  { id: 13, districtId: 19, name: "Doʻrmon" },
  { id: 14, districtId: 19, name: "Savrak" },
  { id: 15, districtId: 19, name: "Sulton Joʻra" },
  { id: 16, districtId: 19, name: "Tezguzar" },
  { id: 17, districtId: 19, name: "Mazlaxon Chandir" },
  { id: 18, districtId: 19, name: "Sh. Hamroyev nomli" },
  { id: 19, districtId: 19, name: "Bogʻiafzal" },
  { id: 20, districtId: 19, name: "Jilvon" },
  { id: 21, districtId: 19, name: "Pashmon" },
  { id: 22, districtId: 19, name: "Beklik" },
  { id: 23, districtId: 19, name: "Chitgaron" },
  { id: 24, districtId: 19, name: "Talisang" },
